...
from .decoder import FPNDecoder,Tissue2Cell, Cell2Tissue


class DoubleNet(MultiBranchModel):
    ...
    def __init__(
        ...
        self.tissue_decoder = FPNDecoder(
        ...
        self.tissue2cell = Tissue2Cell(
            feature_channels=self.cell_encoder.out_channels,
            feature_depth=encoder_depth,
            scale_factor=4)

        self.cell2tissue = Cell2Tissue(
            feature_channels=self.cell_decoder.out_channels,
            feature_depth=0,
            scale_factor=4)
